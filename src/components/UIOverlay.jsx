    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between" style={{ zIndex: 10 }}>
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-[44px] h-[44px] bg-[#0d7c66] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform shadow-md">
            <span 
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4 mt-[-5vh] z-10 relative pointer-events-none">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            <button className="bg-[#0d7c66] text-white rounded-full font-medium hover:bg-[#0a5c4c] transition-all text-[15px] leading-none tracking-[0.05em]" style={{ padding: "16px 42px" }}>
